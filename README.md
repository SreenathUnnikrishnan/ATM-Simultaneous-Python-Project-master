...
# ðŸ¦ Python Command-Line ATM Simulator
...
* ðŸ”’ **Secure Authentication System**
  ...
  * Implements a **3-strike lockout policy**â€”failing to enter the correct PIN 3 times will lock the session and exit the program.
* ðŸ’° **Account Statements**
  * Instantly retrieves and formats the current user's available balance.
* ðŸ§ **Withdrawal Logic**
  * Enforces strict ATM dispensing rules (e.g., funds must be withdrawn in multiples of â‚¬10).
  * Prevents overdrafts with "Insufficient Balance" checks.
* ðŸ¦ **Lodgement (Deposits)**
  * Allows users to deposit funds.
  * Validates that inputted cash matches valid note denominations (multiples of â‚¬10).
* ðŸ”‘ **Security Management (Change PIN)**
...
3. **Select `S`** to view your â‚¬1000 balance.
4. **Select `W`**, type `40`, and see your balance drop to â‚¬960.
